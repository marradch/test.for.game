        ...
        <div class="modal-body">
          <form>
            ...
            <div class="form-group">
              ...
              <div class="form-group" v-if="serverAuthorizationError">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="likes" @click="addLike(post.id)">
                <div class="heart-wrap" v-if="!parseInt(post.likes)">
                  <div class="heart">
              ...
              <template v-for="(comment, index) in post.coments">
              <div style="display: flex">
              <div class="card-text" style="margin: 10px">
                <span v-for="n in comment.dept">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                {{comment.user.personaname + ' - '}}
                <small class="text-muted">{{comment.text}}</small>
                <a href="#" @click="openAnswerForm(index)">Leave answer</a>
              </div>

              <div class="likes" @click="addLikeForComment(index)">
                  <div class="heart-wrap" v-if="!parseInt(comment.likes)">
                      <div class="heart">
                          <svg class="bi bi-heart" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" d="M8 2.748l-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 01.176-.17C12.72-3.042 23.333 4.867 8 15z" clip-rule="evenodd"/>
                          </svg>
              ...
              <div v-if="post.coments[parentForNewComment] != undefined && comment.id == post.coments[parentForNewComment].id" class="form-inline">
                <div class="form-group">
                  <input type="text" class="form-control" v-model="commentText">
                </div>
                <button @click="sendComment" class="btn btn-primary">Add comment</button>
              </div>

              </template>
              <p class="card-text">
                <a href="#" @click="openCommentForm">Add comment</a>
              </p>
              <div v-if="parentForNewComment == 'none'" class="form-inline">
                <div class="form-group">
                  <input type="text" class="form-control" v-model="commentText">
                </div>
                <button @click="sendComment" class="btn btn-primary">Add comment</button>
